...
function imprimirExtrato() {
    ...
    gastoTotal = arrDespesas.reduce((soma, depesa) => {
        return soma + depesa.valor
    }, 0)
...
function filtrarDespesas() {
    ...
    imprimirDespesas(despesasFiltradas)
        ...
        alert("Faltou algum valor ou o valor mínimo não é menor que o máximo ou um dos valores esta neagatiovo")
    }
}
function validarFiltro(tipo, min, max){
    return tipo != "" && min > 0 && min < max
}

//Organizar despesas por valor decrescente
